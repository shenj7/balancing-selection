...
def create_random_forest(dir):
    ...
    print('Accuracy:', calculate_accuracy(forest, features_test, target_test))
    print('Precision:', calculate_precision(forest, features_test, target_test))
    print('Recall:', calculate_recall(forest, features_test, target_test))
    print('F1:', calculate_f1(forest, features_test, target_test))
